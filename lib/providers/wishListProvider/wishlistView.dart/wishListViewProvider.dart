...
import 'package:mainproject/providers/wishListProvider/wishlistView.dart/WishListViewService.dart';
import 'package:mainproject/providers/wishlistProvider/wishlistDataProvider/wishlistService.dart';

class WishListViewProvider extends ChangeNotifier {
  final service = WishListViewService();
  // bool isloading = false;

  addAndRemove(id, context) async {
    // isloading = true;
    notifyListeners();
